...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    // A method that shows a MediaStyle notification with two actions (play/pause, skip to previous).
    // Clicking on the notification launches this activity.
    // It takes one argument that defines the state of MediaSession.
